...
# 本地图像
chenduling_image = face_recognition.load_image_file("chenduling.jpeg")
chenduling_face_encoding = face_recognition.face_encodings(chenduling_image)[0]

# 本地图像二
sunyizheng_image = face_recognition.load_image_file("dongwenhua.jpeg")
sunyizheng_face_encoding = face_recognition.face_encodings(sunyizheng_image)[0]

# 本地图片三
zhangzetian_image = face_recognition.load_image_file("cuitianqi.jpg")
